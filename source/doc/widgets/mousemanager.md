...
demo_script: doc/widgets/mousemanager.js
---

`photonui.MouseManager` allows you to add interactivity to a visual widget (like [`photonui.Canvas`][canvas-doc]).

[canvas-doc]: canvas.html
